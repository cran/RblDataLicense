...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-151920010-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-151920010-1');
</script>
...
<a class="github-button" href="https://github.com/emanuele-guidotti/RblDataLicense" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star emanuele-guidotti/RblDataLicense on GitHub">Star</a>

___

source: https://emanueleguidotti.dev/rbldatalicense/
